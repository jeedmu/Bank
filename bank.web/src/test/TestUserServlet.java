...
public class TestUserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("test").equalsIgnoreCase("3")) {
			// Banks
			Customer customer1111 = new Customer.Builder(0, "1111").setFirstName("c1111").setSurName("s1111").setEmail("c1111@eamv.dk").setPhoneNumber("+45-1111")
					.setAddress("g1111").setZipCode("7400").setCity("Herning").setCountry("Danmark").build();
			customer1111 = employee.createCustomer(customer1111);
			Account account1111 = new Account.Builder(customer1111.getCustomerID(), 1111, 0).setAccountName("Bank 1111").setBalance(new BigDecimal(0.00)).build();
			...
			Customer customer2222 = new Customer.Builder(0, "2222").setFirstName("c2222").setSurName("s2222").setEmail("c2222@eamv.dk").setPhoneNumber("+45-2222")
					.setAddress("g2222").setZipCode("7480").setCity("Vildbjerg").setCountry("Danmark").build();
			customer2222 = employee.createCustomer(customer2222);
			Account account2222 = new Account.Builder(customer2222.getCustomerID(), 1111, 0).setAccountName("Bank 2222").setBalance(new BigDecimal(0.00)).build();
			...
			Customer customer3333 = new Customer.Builder(0, "3333").setFirstName("c3333").setSurName("s3333").setEmail("c3333@eamv.dk").setPhoneNumber("+45-3333")
					.setAddress("g3333").setZipCode("7600").setCity("Struer").setCountry("Danmark").build();
			customer3333 = employee.createCustomer(customer3333);
			Account account3333 = new Account.Builder(customer3333.getCustomerID(), 1111, 0).setAccountName("Bank 3333").setBalance(new BigDecimal(0.00)).build();
